            ...
            <div class="col-12">
                <div class="card card-body">
                    ...
                    <div class="form-group">
                        ...
                        @if($data->image)
                        <img src="{{ asset('upload/user/blog'.$data->image) }}" alt="Blog Image" width="100">
                     @endif
                    </div>
                    ...
                    <div class="form-group">
                        <label>Content</label>
                        <textarea name="content" id="content" class="form-control" rows="5" required>{{ $data->content }}</textarea>
                    </div>
